		...
		<ThemeProvider theme={GLOBAL_THEME}>
			<ParallaxProvider>
				<Router>
					...
					<Route exact={false} path="/frameworks" component={checkAuth() && FrameworksView} />
					<Route exact path="/visualizations" component={checkAuth() && VisualizationsView} />
					<Route exact={false} path="/patterns" component={checkAuth() && PatternsView} />
					<Route exact path="/test" component={checkAuth() && TestView} />
					
					<Route exact path="/profilepage" component={checkAuth() && isLoggedIn() ? ProfilePage : HomeView} />
